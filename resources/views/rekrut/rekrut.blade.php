    ...
    <div class="container">
                ...
                <div class="success-card">
                    ...
                    <div class="success-text">
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Mohon screenshoot bukti lamaran ini. Bukti screenshoot akan digunakan kembali jika
                                lolos ke tahap selanjutnya. </strong>
                        </div>
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle me-2"></i>
        ...
        @else
            ...
            <div class="form-container" id="formContainer">
                ...
                <form action="{{ route('rekrutmen.submit') }}" method="POST" enctype="multipart/form-data"
                    id="recruitmentForm" novalidate>
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control @error('email') is-invalid @enderror" id="email"
                            ...
                            pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" inputmode="email" required
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('telepon') is-invalid @enderror" id="telepon"
                            name="telepon" value="{{ old('telepon') }}" pattern="\d{11,13}" maxlength="13"
                            inputmode="numeric" required placeholder="08123456789">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">Format yang diterima: PDF (Maks. 7MB)</div>
                        @error('cv')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @else
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control @error('ktp') is-invalid @enderror" id="ktp"
                            name="ktp" accept=".jpg,.jpeg,.png" required>
                        <div class="form-text">Format yang diterima: JPG, JPEG, PNG (Maks. 7MB)</div>
                        @error('ktp')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @else
